...
class Espers():
    ...
    def get_random_esper(self):
        ...
        # random.sample no longer accepts sets in Python 3.14.
        # Use a tuple to preserve sample-based RNG behavior.
        rand_esper = random.sample(tuple(self.available_espers), 1)[0]
